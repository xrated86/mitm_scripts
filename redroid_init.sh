...
if $manageSetup ; then
    ...
    wget "https://mirror.unownhash.com/apks/com.nianticlabs.pokemongo_arm64-v8a_${version}.apkm"
...
if $manageRedroid ; then
    ...
    wget 'https://raw.githubusercontent.com/xrated86/mitm_scripts/main/redroid_device.sh' -O redroid_device.sh
    wget 'https://raw.githubusercontent.com/xrated86/mitm_scripts/main/redroid_host.sh' -O redroid_host.sh
